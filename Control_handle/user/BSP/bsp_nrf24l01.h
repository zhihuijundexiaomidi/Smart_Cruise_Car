...
#define NRF24L01_CSN(x)  		 		HAL_GPIO_WritePin(SPI_CSN_GPIO_Port, SPI_CSN_Pin, x);//SPI片选信号	   
#define NRF24L01_IRQ       		  HAL_GPIO_ReadPin(SPI_IRQ_GPIO_Port,SPI_IRQ_Pin) //IRQ主机数据输入
//24L01发送接收数据宽度定义
...
extern  u8 rf_rxbuf[RX_PLOAD_WIDTH+1];
extern char rf_txbuf[TX_PLOAD_WIDTH+1];
